...
function loadMusic(indexNumb){
  if (f === 0) {
    ...
    console.log(name)
    const i = allMusic.findIndex(element => element.id === name)
    console.log(i)
    musicName.innerText = allMusic[i].name;
    musicArtist.innerText = allMusic[i].artist;
    musicImg.src = `images/${allMusic[i].img}.jpg`;
    mainAudio.src = `songs/${allMusic[i].src}.mp3`;
    f = 1;
  }else{
